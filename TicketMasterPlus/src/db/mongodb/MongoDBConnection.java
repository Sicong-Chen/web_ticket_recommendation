...
public class MongoDBConnection implements DBConnection {
	...
	//SearchItem calls DBConnection calls ExternalAPI  --> get items
	// 1) save into DB
	// 2) render and print as HTTP response in SearchItem 
	// 3) do recommendation 

	// First API - SearchItem by referring to ExternalAPI
	// 1) SearchItem - doGet
	// 2) recommendation.java
	@Override
	...
	// Second API - history(favored items)
